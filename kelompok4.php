...
<body>
	<nav class="navbar navbar-expand-md navbar-dark bg-dark sidebarNavigation" data-sidebarClass="navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" href="kelompok4.php?username="<?php $username ?>>Our Team</a>
                </li>
                <li class="nav-item">
    ...
    <table width="device-width" align="center" class="m-t-20">
        <tr>
            <td align="center">
                <img align="center" src="silakos.jpg" width="200px">
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <p>Arif Hayati Indah Lestari</p><br>
                <p>Sikwi Puspitasari</p><br>
                <p>Nur Hilmi Insan Muhammad</p><br>
                <p>Yayan Dwi Krisdiantoro</p>
            </td>
        </tr>
    </table>
